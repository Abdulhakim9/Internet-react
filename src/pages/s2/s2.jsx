...
const S2 = () => {
  ...
  return (
    <div>
      <p className="text-[17px] ml-[120px] mt-[50px]">{t("Example.97")}</p>
      <div className="flex justify-center items-center gap-[50px]">
        <div className="">
          <p className="text-[50px]">{t("Example.98")}</p>
          <p className="text-[black] font-sans leading-6 w-[500px]">{t("Example.99")}</p>
          <p className="text-[black] font-sans leading-6 w-[500px]">{t("Example.100")}</p>
        </div>
        <div className="">
          <img src={img} alt="" />
        </div>
      ...
      <div className="flex justify-center items-center mt-[60px] mb-[60px] gap-[50px]">
